...
class Metadata
{
     ...
     * @var string
     */
    protected static string $idp_x509cert = '';
    /**
     * @var string
     */
    protected static array $idp_x509certMulti = [
        'signing' => [],
        'encryption' => []
    ];
     ...
     * @param $idp_x509cert
     */
    protected static function setIDPX509Certificate(string $idp_x509cert) {
        Metadata::$idp_x509cert = $idp_x509cert;
    }

    /**
     * @param $signing
     */
    protected static function setIDPX509CertificateMultiSigning(array $signing) {
        Metadata::$idp_x509certMulti['signing'] = [];
    }

    /**
     * @param $encryption
     */
    protected static function setIDPX509CertificateMultiEncryption(array $encryption) {
        Metadata::$idp_x509certMulti['encryption'] = [];
    }

    /**
     * @param $signing
     */
    protected static function appendIDPX509CertificateMultiSigning(string $signing) {
        Metadata::$idp_x509certMulti['signing'][] = $signing;
    }

    protected static function getIDPX509CertificateMultiSigning() {
        return Metadata::$idp_x509certMulti['signing'];
    }

    protected static function IDPX509CertificateMultiHasOne() {
        return
            count(self::getIDPX509CertificateMultiEncryption()) == 1 || (count(self::getIDPX509CertificateMultiSigning()) == 1) &&
            strcmp(self::getIDPX509CertificateMultiSigning()[0], self::getIDPX509CertificateMultiEncryption()[0]) == 0;
    }

    /**
     * @param $signing
     */
    protected static function appendIDPX509CertificateMultiEncryption(string $encryption) {
        Metadata::$idp_x509certMulti['encryption'][] = $encryption;
    }

    protected static function getIDPX509CertificateMultiEncryption() {
        return Metadata::$idp_x509certMulti['encryption'];
    }

    /**
     * @return null
     */
    protected static function getIDX509Certificate() {
        return Metadata::$idp_x509cert;
    }

    protected static function unsetIDPX509CertificateMulti() {
        Metadata::setIDPX509CertificateMultiSigning([]);
        Metadata::setIDPX509CertificateMultiEncryption([]);
    }

    protected static function setIDPSSOURL($url) {
        Metadata::$idp['singleSignOnService']['url'] = $url;
    }

    protected static function setEntityId($entity_id) {
        Metadata::$idp['entity_id'] = $entity_id;
    }

    protected static function setIDPSSOBinding($binding) {
        Metadata::$idp['singleSignOnService']['binding'] = $binding;
    }

    protected static function setIDPSLOURL($url) {
        Metadata::$idp['singleLogoutService']['url'] = $url;
    }

    protected static function setIDPSLOBinding($binding) {
        Metadata::$idp['singleLogoutService']['binding'] = $binding;
    }

    protected static function setIDPSLOResponseURL($response_url) {
        Metadata::$idp['singleLogoutService']['responseURL'] = $response_url;
    }
    ...
    protected static function getMetaData() {
        return [
            'idp' => [
                'x509cert' => self::getIDX509Certificate(),
                'x509certMulti' => [
                    'encryption' => '',
                    'signing' => '',
                ]
...
METADATA_TEMPLATE;
    ...
    {
        try {
            $xml = DOM::get()->load($metadata)->getDOM();
            if (!$xml) {
