...
class Constants
{
    ...
    // Selectors
    const SELECTOR_X509 = './md:KeyDescriptor[not(contains(@use, "encryption"))]/ds:KeyInfo/ds:X509Data/ds:X509Certificate';
    const SELECTOR_LOGOUT_ENCRYPTED_ID = '/samlp:LogoutRequest/saml:EncryptedID';
    const SELECTOR_LOGOUT_NAME_ID = '/samlp:LogoutRequest/saml:NameID';
    const SELECTOR_LOGOUT_ISSUER = '/samlp:LogoutRequest/saml:Issuer';
