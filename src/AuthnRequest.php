...
class AuthnRequest
{
     ...
     */
    public function __construct(Settings $settings, bool $forceAuthn = false, bool $isPassive = false, bool $setNameIdPolicy = true, string $nameIdValueReq = null)
    {
